		...
		try
		{
			...
			switch (className)
			{
				case ObfedClassNames.BOOTSTRAP:
					...
					methodNode.instructions.add(new MethodInsnNode(INVOKESTATIC, "co/uk/niadel/mpi/loadhandler/NModLoader", "loadModsFromDir", "()V", false));
					...
					methodNode.instructions.add(new MethodInsnNode(INVOKESTATIC, "co/uk/niadel/mpi/loadhandler/NModLoader", "callAllPreInits", "()V", false));
					...
					methodNode.instructions.add(new MethodInsnNode(INVOKESTATIC, "co/uk/niadel/mpi/modhandler/loadhandler/NModLoader", "callAllInits", "()V", false));
					l10 = new LabelNode();
					...
					methodNode.instructions.add(new MethodInsnNode(INVOKESTATIC, "co/uk/niadel/mpi/modhandler/loadhandler/NModloader", "callAllPostInits", "()V", false));
