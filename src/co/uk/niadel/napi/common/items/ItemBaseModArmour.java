...
public abstract class ItemBaseModArmour extends ItemArmor
{
	...
	public ItemBaseModArmour(ModArmourMaterial material, int renderIndex, int armourType)
	{
		...
		this.overlayIcon = ReflectionManipulateValues.getValue(ItemArmor.class, /* Remember that INSTANCE thing in Item? This is what that was for. */super.instance, "overlayIcon");
