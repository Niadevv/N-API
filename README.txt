...
issue. Basically, Minecraft Forum's Suggestions section suggestion rules.
...
**CREDITS:**
- Gradle, for breaking and not letting me download more than a few dependencies, thus making me unable to use Forge as of 1.7.2 and
prompting me to make this.
...
- The MCP, for their amazing work for the modding community, without which I wouldn't be here today, and neither would Forge or
any other modding APIs.